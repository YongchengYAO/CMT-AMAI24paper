function faces_out = cal_extractFaces_AND(faces_source, vers_source, vers_in)
% ==============================================================================
% FUNCTION:
%     Extract faces whose vertices are the target vertices.
%
% INPUT:
...
faces_out = faces_source(sum(ismember(faces_source, verIDs), 2)==3,:);
